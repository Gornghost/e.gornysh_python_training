    ...
    def get_contact_list(self):
        ...
        try:
            ...
            for row in cursor:
                ...
                list.append(Contact(id=str(id), first_name=firstname, last_name=lastname, home_phone=home,
                                    mobile_phone=mobile, work_phone=work, home_phone2=phone2, address=address,
